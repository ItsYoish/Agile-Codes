...
<head>
    ...
    <title>Bowser Management - AquaAlert</title>
...
<body>
    <nav class="navbar">
        ...
        <div class="nav-links">
            ...
            <a href="management.php" class="active">Bowser Management</a>
    ...
    <div class="modal" id="bowserModal">
        ...
        <div class="modal-body">
            <form id="bowserForm">
                <div class="input-group">
                    ...
                    <input type="text" id="bowserId" required placeholder="Enter bowser ID">
                </div>
                <div class="input-group">
                    <label for="bowserCapacity">Capacity (Liters)</label>
                    <input type="number" id="bowserCapacity" required placeholder="Enter capacity">
                </div>
                <div class="input-group">
                    <label for="bowserLocation">Current Location</label>
                ...
                <div class="input-group">
                    <label for="bowserStatus">Status</label>
                ...
                <div class="input-group">
                    <label for="bowserNotes">Notes</label>
